...
export function CCTV({ navigation }) {
  const [Facedata, setFacedata] = useState("");
  const [MsgData, setMsgData] = useState("");
  const starCountRef = ref(db, "ESP32/stream_dataface");
        ...
        <WebView
          ...
          source={{
            html: `
                        ...
                        height: 100vh;
                        margin: 0;"> 
                        <head><meta name="viewport" content="initial-scale=1.0, maximum-scale=1.0"></heaad>
      ...
      {/* <View style={stylesApp.glassCard}>
                ...
                <HStack spacing={130} style={stylesApp.StackBg}>
                    <VStack spacing={30} m={-100}>
                        ...
                        >
                            <TouchableOpacity onPress={() => sendData("stream")} style={{ width: "100%", height: '100%' }}>
                        ...
                        <LinearGradient
                            ...
                            style={stylesApp.stream}
                        >
                            <TouchableOpacity onPress={() => sendData("detect")} style={{ width: "100%", height: '100%' }}>
                    ...
                    <VStack spacing={30} m={-100}>
                        <LinearGradient
                            ...
                            style={stylesApp.stream}
                        >
                            <TouchableOpacity onPress={() => sendData("recognise")} style={{ width: "100%", height: '100%' }}>
                        ...
                        <LinearGradient
                            ...
                            style={stylesApp.stream}
                        >
                            <TouchableOpacity onPress={() => setModalVisible(true)} style={{ width: "100%", height: '100%' }}>
